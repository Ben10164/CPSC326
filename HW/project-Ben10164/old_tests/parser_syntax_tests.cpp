...
{
    stringstream in(build_string({"struct my_struct {",
                                  "  int x1, ",
                                  "  double x2, ",
                                  "  bool x3, ",
                                  "  char x4, ",
...
{
    stringstream in(build_string({"int my_fun() {",
                                  "  return 0",
                                  "}"}));
    ASTParser(Lexer(in)).parse();
}
...
{
    stringstream in(build_string({"int my_fun(int x) {",
                                  "}"}));
    ASTParser(Lexer(in)).parse();
}
...
{
    stringstream in(build_string({"int my_fun(int x1, double x2, bool x3, char x4, string x5) {",
                                  "}"}));
    ASTParser(Lexer(in)).parse();
}
...
{
    stringstream in(build_string({"int my_fun(my_struct x1, array int x2, array my_struct x3) {",
                                  "}"}));
    ASTParser(Lexer(in)).parse();
}
...
{
    stringstream in(build_string({"void my_fun(int x, int y) {",
                                  "  z = f()",
                                  "  z = f(x)",
                                  "  z = f(x, y)",
                                  "  z = f(x, y, z)",
...
{
    stringstream in(build_string({"bool my_fun(bool x, bool y) {",
...
{
    stringstream in(build_string({"bool my_fun(int x, int y) {",
...
{
    stringstream in(build_string({"int my_fun(int x, int y) {",
                                  "  z = x + y - z * u / v",
...
{
    stringstream in(build_string({"void my_fun(int z) {",
...
{
    stringstream in(build_string({"bool my_fun(int z) {",
                                  "  int x = 1",
                                  "  x = 2",
...
// expressions
TEST(BasicASTParserTests, TestAdded1)
{
    stringstream in("void f(");
    try
    {
...
TEST(BasicASTParserTests, TestAdded2)
{
...
TEST(BasicASTParserTests, TestAdded3)
{
...
TEST(BasicASTParserTests, TestAdded4)
{
...
TEST(BasicASTParserTests, TestAdded5)
{
    stringstream in("void f()}");
    try
    {
...
TEST(BasicASTParserTests, TestAdded6)
{
    stringstream in(build_string({"",
                                  "int",
                                  "main()",
