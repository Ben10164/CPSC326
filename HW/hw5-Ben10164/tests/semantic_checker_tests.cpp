...
TEST(BasicSemanticCheckerTests, Ben1) {
  stringstream in(build_string({
        "void main() {",
        "  array int x1 = new string[10]", // fail :)
        "  array int x2 = x1",
        "  bool x3 = (x2 != null) and ((x1 != x2) or (x1 == x2))", 
        "}",
      }));
...
TEST(BasicSemanticCheckerTests, Ben2) {
  stringstream in(build_string({
        "void main() {",
        "  array int x1 = new int[10]",
        "  int x2 = x1", // fail :)
...
TEST(BasicSemanticCheckerTests, Ben3) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
        "  s.x = new int[100]",
        "  s.x[20] = 5.5", // fail :)
...
TEST(BasicSemanticCheckerTests, Ben4) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
...
TEST(BasicSemanticCheckerTests, Ben5) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
...
TEST(BasicSemanticCheckerTests, Ben6) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
...
TEST(BasicSemanticCheckerTests, Ben7) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
...
TEST(BasicSemanticCheckerTests, Ben8) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
...
TEST(BasicSemanticCheckerTests, Ben9) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
...
TEST(BasicSemanticCheckerTests, Ben10) {
  stringstream in(build_string({
        "struct s {array int x}",
        "void main() {",
        "  s s = new s",
